#ifndef SELECTION_JUKEBOX_DX_MAP_H
#define SELECTION_JUKEBOX_DX_MAP_H
#define selection_jukebox_dx_data_length 22U
#define selection_jukebox_dx_data_length2 21U
#define selection_jukebox_dx_tiles_width 16U
#define selection_jukebox_dx_tiles_height 6U
