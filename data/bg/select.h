...
const unsigned char select_tiles[] = {
     ...
     13,  27,  29,  29,  16,  13,  13,   4,  29,  29,  16,  13,  13,   4,  29,  29,
     16,  13,  13,   4,  29,  29,  16,  13,  13,   4,  29,  29,  16,  13,  13,   4,
     29,  29,  16,  13,  13,  42
};
const unsigned char select_palettes[] = {
      0,   0,  66,   1,   1,   8,   0,   0,  51,   2,   2,  10,   0,   0,  10,   2,
      2,  10,   0,   0,  10,   2,   2,  10,   0,   0,  27,   2,   2,  16,   0,   0,
      4,   2,   2,  16,   0,   0,   4,   2,   2,  16,   0,   0,   4,   2,   2,  16,
      0,   0,   4,   2,   2,  16,   0,   0,   4,   2,   2,  16,   0,   0,  42
};
