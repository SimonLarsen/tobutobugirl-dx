#ifndef SELECTION_LOCKED_MAP_H
#define SELECTION_LOCKED_MAP_H
#define selection_locked_data_length 17U
#define selection_locked_data_length2 16U
#define selection_locked_tiles_width 16U
