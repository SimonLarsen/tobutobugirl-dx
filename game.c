...
void restoreGame(UBYTE update, UBYTE from_pause) {
    ...
    setIngameBackground(special_wave ? 255U : level+wave_bg, update, !from_pause);
...
void generateSpawnData() {
    ...
    else if(special_wave == WAVE_SPC_DOUBLESPIKES) {
